		...
		<!--订单明细开始-->
			...
			<s:iterator id="orderDetailItem" value="#request.orderDetailList">
				...
				<div class="car_c fl">
					...
					<p class="del fl"><s:property value="bi.code"/> </p>
					<p class="spmc fl"><s:property value="bi.name"/></p>
					
					<p class="dj fl"><s:property value="bi.price"/></p>
					<p class="sl fl"><s:property value="num"/></p>
					<p class="je fl">￥<s:property value="bi.price*num"/></p>
					
				</div>
				<s:set var="count" value="#count+bi.price*num"/>
			</s:iterator>	
			...
			<div class="car_c fl" style="background-color:#ccccee;">
				...
				<p class="dj fl">-</p>
				<p class="sl fl">-</p>
				<p class="je fl">￥<s:property value="#count"/> </p>
