...
<body>
	...
	<div id="ordertb" style="padding:2px 5px;">
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
			onclick="addOrderDetail();">添加订单明细</a><a href="#"
			class="easyui-linkbutton" iconCls="icon-save" plain="true"
			onclick="saveorder();">保存订单</a><a href="#" class="easyui-linkbutton"
	...
	<div id="divOrderInfo">
		<div style="padding:3px">
			客户名称&nbsp;<input style="width:115px;" id="create_uid" class="easyui-combobox" name="create_uid" value="0"
				data-options="valueField:'id',textField:'userName',url:'getValidUser'">&nbsp;&nbsp;&nbsp;
			订单金额&nbsp;<input type="text" name="create_orderprice" id="create_orderprice"
				class="easyui-textbox" readonly="readonly" style="width:115px" /> &nbsp;&nbsp;	
		</div>
		<div style="padding:3px">
			订单日期&nbsp;<input type="text" name="create_ordertime" id="create_ordertime"
				class="easyui-datebox" style="width:115px" /> &nbsp;&nbsp;
			订单状态&nbsp;<select
				id="create_status" class="easyui-combobox" name="create_status"
				style="width:115px;">
		...
		function removeOrderDetail() {
			...
			if (rows.length > 0) {
				...
				for (var i = 0; i < rows.length; i++) {
		            ...
		            // alert($(totalpriceEd.target).numberbox('getValue'));		             
